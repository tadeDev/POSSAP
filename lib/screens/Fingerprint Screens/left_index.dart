            ...
            child: SafeArea(
              child: Column(
                children: [
                  ...
                  Stack(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: (controller.lIImageUrl != "")?
                            NetworkImage(controller.lIImageUrl)
                            :
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: (){
                            controller.getLIBiometricsImage(ImageSource.camera);
                          },
                          child: Container(
                            height: 50,
                            width: 50,
                  ...
                  Text(
                    (controller.lIImageUrl != "")?
                    "Good!!!"
                    :
                    "Please insert left index finger",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 16,
                      color: (controller.lIImageUrl != "")?
                      Colors.green
                      :
                      Colors.red
                    ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                          Get.offAllNamed(leftMiddleAuth);
                        },
                        child: Container(
                          height: 50,
                          width: 50,
