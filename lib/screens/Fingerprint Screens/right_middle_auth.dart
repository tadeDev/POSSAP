...
class RightMiddleAuth extends StatelessWidget {
  RightMiddleAuth({super.key});
            ...
            child: SafeArea(
              child: Column(
                children: [
                  ...
                  Stack(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: (controller.rMImageUrl != "")?
                            NetworkImage(controller.rMImageUrl)
                            :
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: (){
                            controller.getRMBiometricsImage(ImageSource.camera);
                          },
                          child: Container(
                            height: 50,
                            width: 50,
                  ...
                  Text(
                    (controller.rMImageUrl != "")?
                    "Good!!!"
                    :
                    "Please insert right middle finger",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 16,
                      color: (controller.rMImageUrl != "")?
                      Colors.green
                      :
                      Colors.red
                    ),
