...
class RightRingAuth extends StatelessWidget {
  RightRingAuth({super.key});
            ...
            child: SafeArea(
              child: Column(
                children: [
                  ...
                  Stack(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: (controller.rRImageUrl != "")?
                            NetworkImage(controller.rRImageUrl)
                            :
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: (){
                            controller.getRRBiometricsImage(ImageSource.camera);
                          },
                          child: Container(
                            height: 50,
                            width: 50,
                  ...
                  Text(
                    (controller.rRImageUrl != "")?
                    "Good!!!"
                    :
                    "Please insert right ring finger",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 16,
                      color: (controller.rRImageUrl != "")?
                      Colors.green
                      :
                      Colors.red
                    ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                          Get.offAllNamed(rightPinkyAuth);
                        },
                        child: Container(
                          height: 50,
                          width: 50,
