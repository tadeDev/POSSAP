...
class LeftRingAuth extends StatelessWidget {
  LeftRingAuth({super.key});
            ...
            child: SafeArea(
              child: Column(
                children: [
                  ...
                  Stack(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: (controller.lRImageUrl != "")?
                            NetworkImage(controller.lRImageUrl)
                            :
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: (){
                            controller.getLRBiometricsImage(ImageSource.camera);
                          },
                          child: Container(
                            height: 50,
                            width: 50,
                  ...
                  Text(
                    (controller.lRImageUrl != "")?
                    "Good!!!"
                    :
                    "Please insert left ring finger",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 16,
                      color: (controller.lRImageUrl != "")?
                      Colors.green
                      :
                      Colors.red
                    ),
