...
class LeftMiddleAuth extends StatelessWidget {
  LeftMiddleAuth({super.key});
            ...
            child: SafeArea(
              child: Column(
                children: [
                  ...
                  Stack(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: (controller.lMImageUrl != "")?
                            NetworkImage(controller.lMImageUrl)
                            :
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: (){
                            controller.getLMBiometricsImage(ImageSource.camera);
                          },
                          child: Container(
                            height: 50,
                            width: 50,
                  ...
                  Text(
                    (controller.lMImageUrl != "")?
                    "Good!!!"
                    :
                    "Please insert left middle finger",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 16,
                      color: (controller.lMImageUrl != "")?
                      Colors.green
                      :
                      Colors.red
                    ),
