...
class RightPinkyAuth extends StatelessWidget {
  RightPinkyAuth({super.key});
            ...
            child: SafeArea(
              child: Column(
                children: [
                  ...
                  Stack(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: (controller.rPImageUrl != "")?
                            NetworkImage(controller.rPImageUrl)
                            :
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: (){
                            controller.getRPBiometricsImage(ImageSource.camera);
                          },
                          child: Container(
                            height: 50,
                            width: 50,
                  ...
                  Text(
                    (controller.rPImageUrl != "")?
                    "Good!!!"
                    :
                    "Please insert right pinky finger",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 16,
                      color: (controller.rPImageUrl != "")?
                      Colors.green
                      :
                      Colors.red
                    ),
