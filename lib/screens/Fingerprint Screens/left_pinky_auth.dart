...
class LeftPinkyAuth extends StatelessWidget {
  LeftPinkyAuth({super.key});
            ...
            child: SafeArea(
              child: Column(
                children: [
                  ...
                  Stack(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: (controller.lPImageUrl != "")?
                            NetworkImage(controller.lPImageUrl)
                            :
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: (){
                            controller.getLPBiometricsImage(ImageSource.camera, context);
                          },
                          child: Container(
                            height: 50,
                            width: 50,
                  ...
                  Text(
                    (controller.lPImageUrl != "")?
                    "Good!!!"
                    :
                    "Please insert left pinky finger",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 16,
                      color: (controller.lPImageUrl != "")?
                      Colors.green
                      :
                      Colors.red
                    ),
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                          showDialog(
                            context: context, 
                            builder: ((context) => const SubmittedSuccessful())
                          );
                        },
                        child: Container(
                          height: 50,
