            ...
            child: SafeArea(
              child: Column(
                children: [
                  ...
                  Stack(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: (controller.rIImageUrl != "")?
                            NetworkImage(controller.rIImageUrl)
                            :
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: (){
                            controller.getRIBiometricsImage(ImageSource.camera);
                          },
                          child: Container(
                            height: 50,
                            width: 50,
                  ...
                  Text(
                    (controller.rIImageUrl != "")?
                    "Good!!!"
                    :
                    "Please insert right index finger",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 16,
                      color: (controller.rIImageUrl != "")?
                      Colors.green
                      :
                      Colors.red
                    ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                          Get.offAllNamed(rightMiddleAuth);
                        },
                        child: Container(
                          height: 50,
                          width: 50,
